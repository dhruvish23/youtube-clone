...
export const getHomePageVideos = createAsyncThunk(
    ...
    async (isNext, { getState }) => {
        ...
        const response = await axios.get(`https://youtube.googleapis.com/youtube/v3/search?maxResults=20&q="tmkoc"&key=${API_KEY}&part=snippet&type=video&${isNext ? `pageToken=${nextPageTokenFromState}`:""}`);
